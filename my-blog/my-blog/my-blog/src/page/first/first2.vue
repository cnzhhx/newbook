<template>
    <div class="first2">
        <div class="top">
            <div class="xiaozhjpg">
                <img src="../../assets/-34550ac663a8f32b.jpg">
            </div>
            <p class="topp1">hello，我叫张浩翔</p>
            <p class="topp2">一名学习前端开发的学生</p>
...
<style scoped>
    ...
    .top{
        background-image:  url('../../assets/4721555e92120412e03c56d6857af908.jpeg');
        text-align: center;
    }
    .top p{
